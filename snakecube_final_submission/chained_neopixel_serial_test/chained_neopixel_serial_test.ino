// Test of daisy chained NEOPIXEL sticks. Enter ID of LED in serial monitor
// to turn on that LED. Starts with ID of 0 (first LED) and also resorts to
// ID of 0 when an invalid input is given (ID not in range of IDs)
