// Test to ensure soldered connections work for one face of the cube
// Starts with id of 0 (first LED) and also
// resorts to id of 0 when an invalid input is given (id not in range of IDs)

#include <Adafruit_NeoPixel.h> // Include the NeoPixel library

#define LED_PIN 0 // define the Arduino pin that the first NeoPixel's DIN is connected to
